...
const Sidebar = () => {
  ...
  return (
    <div
      className={cn(
        `relative z-50 w-18 md:w-48 ${sidebarOpen ? "md:w-48" : "md:w-18"} bg-white px-2 py-4 border-r flex flex-col items-center justify-between gap-6 transition-all duration-200`,
      )}
    >
